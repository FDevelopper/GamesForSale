...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || Games for Sale</title>
  ...
  <input type="hidden" name="business" value="GamesForSaleEasyAndSimple@hotmail.com">
  ...
  <align="center"><input type="image" name="submit" border="0"
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy;  Games for Sale. All Rights Reserved.</p>
        </footer>
